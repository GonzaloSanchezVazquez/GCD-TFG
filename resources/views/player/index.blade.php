    ...
    <section class="container">
        <div class="row submenu-player">
            ...
            <div class="col-12 col-md-6 margin-bottom_40-xs">
                <a href="{{url('/player/create')}}"><img src="{{asset('images/jugadores.png')}}" alt="usuario jugador" id="jugador"/><br><h2>Jugador</h2></a>
            </div>

            <div class="col-12 col-md-6">
                <a href="{{url('/club/create')}}"><img src="{{asset('images/logo-club.png')}}"alt="usuario club" id="club" /><br><h2>Club organizador</h2></a>
            </div>
    ...
    <script>
        $( document ).ready(function() {
            ...
            $('.submenu-player a #jugador').mouseenter(function () {
                $('.submenu-player a #jugador').attr('src','http://127.0.0.1:8000/images/jugadores-color.png')
            });
            $('.submenu-player a #jugador').mouseleave(function () {
                $('.submenu-player a #jugador').attr('src','http://127.0.0.1:8000/images/jugadores.png')
            });
